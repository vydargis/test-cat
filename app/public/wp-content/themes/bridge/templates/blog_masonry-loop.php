		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post_text">
				<div class="post_text_inner">
					...
					<?php qode_excerpt(); ?>
					<div class="post_info">
						<span itemprop="dateCreated" class="time entry_date updated"><?php the_time('F j, Y'); ?><meta itemprop="interactionCount" content="UserComments: <?php echo get_comments_number(qode_get_page_id()); ?>"/></span>
