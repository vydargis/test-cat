...
if(!function_exists('qode_haeder_options_map')) {
    ...
    function qode_haeder_options_map(){
        ...
        $header_bottom_appearance = new QodeField("select", "header_bottom_appearance", "regular", "Header Type", "Choose the header layout & behavior",
			array(
			"regular" => "Regular",
            "fixed" => "Fixed",
        ...
        qode_add_admin_field(array(
            ...
            'default_value' => 'no',
            'label'         => esc_html__('Sticky Mobile Header', 'qode'),
            'description'   => esc_html__('Enable this option if you want sticky mobile header','qode')
        ));
...
//        $panel10->addChild("enable_wide_manu_background", $enable_wide_manu_background);
		...
		$qode_enable_wide_menu_container = qode_add_admin_container(
			array(
				'parent'          => $panel10,
		...
		qode_add_admin_field(
			array(
				...
				'type'          => 'yesno',
				'default_value' => 'no',
				'label'         => 'Enable Full Width Menu for Wide Dropdown Type',
				'description'   => 'Enabling this option will display the wide menu in full width',
	...
	", array(), array("dependence" => true, "dependence_hide_on_yes" => "", "dependence_show_on_yes" => "#qodef_enable_search_container"));
        ...
        $popup_menu_texttransform = new QodeField("selectblanksimple", "popup_menu_texttransform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
        ...
        $popup_menu_texttransform_2nd = new QodeField("selectblanksimple", "popup_menu_texttransform_2nd", "", "Text Transform", "This is some description", qode_get_text_transform_array());
        ...
        qode_add_admin_field(array(
            ...
            'description'   => esc_html__('Select background image for full screen menu')
        ));
