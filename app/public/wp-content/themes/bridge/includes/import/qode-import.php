...
class Qode_Import
{
    ...
    public function demos_import_list() {
        ...
        $demos = array(
			...
			'bridgedb224' => array(
				'title' => esc_html__('New Demo 224 - Travel', 'qode'),
				'rev-sliders' => array('home-slider.zip'),
				'layer-sliders' => array(),
			...
			'bridgedb228' => array(
				'title' => esc_html__('New Demo 228 - Water Plant', 'qode'),
				'rev-sliders' => array('home-slider.zip'),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
			),
			'bridgedb229' => array(
				'title' => esc_html__('New Demo 229 - Spa & Wellness', 'qode'),
				'rev-sliders' => array('home.zip'),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
			),
			'bridgedb230' => array(
				'title' => esc_html__('New Demo 230 - Nail Salon', 'qode'),
				'rev-sliders' => array('home.zip'),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'revslider', 'contact-form-7', 'qode-instagram-widget')
			),
			'bridgedb231' => array(
				'title' => esc_html__('New Demo 231 - Educational Center', 'qode'),
				'rev-sliders' => array('home-slider.zip'),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'revslider', 'contact-form-7', 'woocommerce', 'qode-lms', 'qode-woocommerce-checkout-integration')
			),
			'bridgedb232' => array(
				'title' => esc_html__('New Demo 232 - Trendy Blog', 'qode'),
				'rev-sliders' => array(),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'contact-form-7', 'qode-instagram-widget')
			),
			'bridgedb233' => array(
				'title' => esc_html__('New Demo 233 - Creative Office', 'qode'),
				'rev-sliders' => array('home.zip'),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
			),
			'bridgedb234' => array(
				'title' => esc_html__('New Demo 234 - Backpacks', 'qode'),
				'rev-sliders' => array('home-slider.zip'),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
			),
			'bridgedb235' => array(
				'title' => esc_html__('New Demo 235 - Mountain Climbing', 'qode'),
				'rev-sliders' => array('home.zip'),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'revslider', 'contact-form-7', 'qode-instagram-widget')
			),
			'bridgedb236' => array(
				'title' => esc_html__('New Demo 236 - Developer Portfolio', 'qode'),
				'rev-sliders' => array(),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'contact-form-7')
			),
			'bridgedb237' => array(
				'title' => esc_html__('New Demo 237 - Jewelry', 'qode'),
				'rev-sliders' => array('home.zip'),
				'layer-sliders' => array(),
				'required-plugins' => array('js_composer', 'revslider', 'contact-form-7', 'woocommerce', 'qode-instagram-widget')
			),
            'bridgedb238' => array(
                'title' => esc_html__('New Demo 238 - Designer Presentation', 'qode'),
                'rev-sliders' => array('home.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7', 'qode-instagram-widget')
            ),
            'bridgedb239' => array(
                'title' => esc_html__('New Demo 239 - Beachwear Store', 'qode'),
                'rev-sliders' => array('home.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7', 'woocommerce')
            ),
            'bridgedb240' => array(
                'title' => esc_html__('New Demo 240 - Exotic Travels', 'qode'),
                'rev-sliders' => array('home.zip', 'section1.zip', 'video.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7', 'qode-instagram-widget')
            ),
            'bridgedb241' => array(
                'title' => esc_html__('New Demo 241 - TV Set Showcase', 'qode'),
                'rev-sliders' => array('home.zip'),
                'layer-sliders' => array(),
                'required-plugins' => array('js_composer', 'revslider', 'contact-form-7')
            ),
	...
	public function qode_xml_files()	{
		...
		foreach ($demos as $demo => $value) {
			if (strpos($demo, 'db') !== false) {
				...
				echo '<a href="http://'.str_replace('db', '', $demo).'.qodeinteractive.com/" target="_blank" class="qode-demo-list-launch">' . esc_html__('Launch', 'qode') . '</a>';
				echo '<span class="qode-demo-separator">|</span>';
				echo '<a href="http://export.qodethemes.com/bridge-export/'. str_replace('db', '', $demo) .'-export.zip" class="qode-demo-list-download">' . esc_html__('Download', 'qode') . '</a>';
				echo '</li>'. "\n";
			} else {
				echo '<li><span class="qode-demo-title">'.$value['title'].'</span>';
				echo '<a href="http://demo.qodeinteractive.com/'.$demo.'" target="_blank" class="qode-demo-list-launch">' . esc_html__('Launch', 'qode') . '</a>';
				echo '<span class="qode-demo-separator">|</span>';
				echo '<a href="http://export.qodethemes.com/bridge-export/demo-' . $demo . '-export.zip" class="qode-demo-list-download">' . esc_html__('Download', 'qode') . '</a>';
				echo '</li>'. "\n";
			}
